...
class MailchimpEcommerce extends Mailchimp
{
    ...
    public function getCartLine($store_id, $cart_id, $line_id, $parameters = [])
    {
        ...
        return $this->request('GET', '/ecommerce/stores/{store_id}/carts/{cart_id}/lines/{line_id}', $tokens,
            $parameters);
    }
    ...
    public function addCartLine($store_id, $cart_id, $id, $product, $batch = false)
    {
        ...
        return $this->request('POST', '/ecommerce/stores/{store_id}/carts/{cart_id}/lines', $tokens, $parameters,
            $batch);
    }
    ...
    public function updateCartLine($store_id, $cart_id, $line_id, $parameters = [], $batch = false)
    {
        ...
        return $this->request('PATCH', '/ecommerce/stores/{store_id}/carts/{cart_id}/lines/{line_id}', $tokens,
            $parameters, $batch);
    }
    ...
    public function getCustomer($store_id, $customer_id, $parameters = [])
    {
        ...
        return $this->request('GET', '/ecommerce/stores/' . $store_id . '/customers/' . $customer_id, $tokens,
            $parameters);
    }
    ...
    public function updateCustomer($store_id, $customer, $batch = false)
    {
        ...
        return $this->request('PATCH', '/ecommerce/stores/{store_id}/customers/{customer_id}', $tokens, $customer,
            $batch);
    }
    ...
    public function getOrderLine($store_id, $order_id, $line_id, $parameters = [])
    {
        ...
        return $this->request('GET', '/ecommerce/stores/{store_id}/orders/{order_id}/lines/{line_id}', $tokens,
            $parameters);
    }
    ...
    public function addOrderLine($store_id, $order_id, $id, $product, $batch = false)
    {
        ...
        return $this->request('POST', '/ecommerce/stores/{store_id}/orders/{order_id}/lines', $tokens, $parameters,
            $batch);
    }
    ...
    public function addProductVariant($store_id, $product_id, $parameters = [])
    {
        ...
        return $this->request('POST', '/ecommerce/stores/{store_id}/products/{product_id}/variants', $tokens,
            $parameters);
    }
    ...
    public function updateProductVariant($store_id, $product_id, $variant_id, $parameters = [])
    {
        ...
        return $this->request('PATCH', '/ecommerce/stores/{store_id}/products/{product_id}/variants/{variant_id}',
            $tokens, $parameters);
    }
    ...
    public function getProductVariant($store_id, $product_id, $variant_id)
    {
        ...
        return $this->request('GET', '/ecommerce/stores/{store_id}/products/{product_id}/variants/{variant_id}',
            $tokens);
    }
    ...
    public function deleteProductVariant($store_id, $product_id, $variant_id)
    {
        ...
        return $this->request('DELETE', '/ecommerce/stores/{store_id}/products/{product_id}/variants/{variant_id}',
            $tokens);
    }
